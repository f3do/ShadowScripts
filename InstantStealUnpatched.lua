...
watermarkLabel.Text = "by @Shadow Scripts"
...
discordLabel.Text = "INSTANT STEAL SCRIPT LOADING..."
...
while true do
	...
	if percent >= 95 then
		...
		miniLoadingLabel.Text = "Completed"
...
print("Loading complete! Interface removed.")
...
local function runSequence()
	...
	task.spawn(function()
		...
		if stolenItem then
			player:Kick('You stole a ' .. rarity .. ' ' .. stolenItem .. ' STOLEN (from ShadowScripts.')
		end
